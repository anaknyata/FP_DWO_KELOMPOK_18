<?php
include 'data/dashboardData.php';
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 ps bg-white" id="sidenav-main" data-color="primary">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" index.php " target="_blank">
        <img src="http://localhost/fpdwo/assets/img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="col-md-12 p-4">
      <a href="javascript:;">
        <div class="card card-background move-on-hover">
          <div class="full-background" style="background-image: url('https://www.adventureworks.com/wp-content/uploads/2018/12/AdvW-logo-color-1030x248.png')"></div>
          <div class="card-body pt-12">
            <h4 class="text-white">Adventureworks</h4>
            <p>In 1987 we started creating adventures that would connect and inspire—join us as we strive to do good, work smart, live well, and laugh often through all of our adventures!</p>
          </div>
        </div>
      </a>
    </div>
